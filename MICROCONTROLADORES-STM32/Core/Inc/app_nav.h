...
AppNavPrimitiveTestState App_NavPrimitiveTest_Tick(const AppNavInput *input, const AppNavPerception *perception, AppNavOutput *output);
 ...
 * cell entry.
 */
bool App_Nav_StartSmoothActionWithRearTapeProfile(AppNavSmoothActionType action, AppNavRearTapeProfile rear_tape_profile);
AppNavSmoothActionState App_Nav_TickSmoothAction(const AppNavInput *input, const AppNavPerception *perception, AppNavOutput *output);
...
AppNavPivotActionState App_Nav_TickPivotAction(const AppNavInput *input, const AppNavPerception *perception, AppNavOutput *output);
...
AppNavApproachFrontWallActionState App_Nav_TickApproachFrontWallAction(const AppNavInput *input, const AppNavPerception *perception, AppNavOutput *output);
...
AppNavCenterFrontTapeActionState App_Nav_TickCenterByFrontTapeForPivotAction(const AppNavInput *input, const AppNavPerception *perception, AppNavOutput *output);
